...
```bash
python /home/runner/work/GithubRepoMonitor/GithubRepoMonitor/src/github_repo_monitor.py
```

可选配置文件：

```bash
python /home/runner/work/GithubRepoMonitor/GithubRepoMonitor/src/github_repo_monitor.py --config /absolute/path/config.json
```
